...
add wave -noupdate -group inst_rom_wrap_i -label CLK /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/clk
add wave -noupdate -group inst_rom_wrap_i -label RST_N /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/rst_n
add wave -noupdate -group inst_rom_wrap_i -label EN /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/en_i
add wave -noupdate -group inst_rom_wrap_i -label Addr -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/addr_i
add wave -noupdate -group inst_rom_wrap_i -label RDATA /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/rdata_o
add wave -noupdate -group {INST ROM INST} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/inst_ROM_i/CLK
add wave -noupdate -group {INST ROM INST} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/inst_ROM_i/RSTN
add wave -noupdate -group {INST ROM INST} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/inst_ROM_i/CSN
add wave -noupdate -group {INST ROM INST} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/inst_ROM_i/A
add wave -noupdate -group {INST ROM INST} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/inst_ROM_i/A_Q
add wave -noupdate -group {INST ROM INST} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/instruction_ram_wrap_instance/inst_rom_wrap_i/inst_ROM_i/Q
...
add wave -noupdate -group {AXI 2 APB bridge (B)} /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_b_buffer/master_valid_o
add wave -noupdate -group {AXI 2 APB bridge (B)} /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_b_buffer/buffer_i/CS
add wave -noupdate -group {AXI 2 APB bridge (B)} /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_b_buffer/buffer_i/valid_o
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/data_i
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/valid_i
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/grant_o
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/data_o
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/valid_o
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/grant_i
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/test_mode_i
add wave -noupdate -group {AXI 2 APB Bridge (W)} -radix hexadecimal /mcu_top_level_tb/mcu_top_inst/axi2apb_bridge_instance/genblk1/axi2apb_i/Slave_w_buffer/buffer_i/CS
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {15280 ps} 0}
quietly wave cursor active 1
configure wave -namecolwidth 747
